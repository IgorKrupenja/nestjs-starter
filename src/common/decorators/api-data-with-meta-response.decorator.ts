...
export const ApiOkDataWithMetaResponse = <TData extends Type, TMeta extends Type>(
  args: Omit<ApiDataWithMetaResponseArgs<TData, TMeta>, 'status'>,
): MethodDecorator & ClassDecorator => ApiDataWithMetaResponse({ ...args, status: HttpStatus.OK });
